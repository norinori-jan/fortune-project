# generate_lopan_design_master_v1_104div.py
# 104区間の羅盤データをCSV出力するスクリプト
# 出力ファイル: lopan_design_master_v1_104div.csv
...
def main():
    ...
    with open('lopan_design_master_v1_104div.csv', 'w', newline='', encoding='utf-8-sig') as f:
        writer = csv.writer(f)
        writer.writerow([
            'index',
            'start_angle',
    ...
    print(f"Generated lopan_design_master_v1_104div.csv with {len(rows)} rows.")
