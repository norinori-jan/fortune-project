...
def get_ten_god(day_stem: str, target_stem: str) -> str:
    return TEN_GODS_TABLE.get(day_stem, {}).get(target_stem, "不明")

def get_pillar_ten_gods(day_stem: str, pillars: dict) -> dict:
    return {
        "year_stem_god":  get_ten_god(day_stem, pillars["year"]["stem"]),
        "month_stem_god": get_ten_god(day_stem, pillars["month"]["stem"]),
        "day_stem_god":   "比肩",
        "hour_stem_god":  get_ten_god(day_stem, pillars["hour"]["stem"]),
    }
